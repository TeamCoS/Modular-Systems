...
public class DummyRFBlock extends DummyBlock {

    public DummyRFBlock(CreativeTabs tab, Material material, boolean inTab) {
        super(tab, material, inTab);
        setStepSound(Block.soundTypeStone);
        setHardness(3.5f);
        setBlockName("modularsystems:blockDummyRF");
    }

    @Override
    public void breakBlock(World world, int x, int y, int z, Block par5, int par6) {
        DummyRFTile dummy = (DummyRFTile)world.getTileEntity(x, y, z);

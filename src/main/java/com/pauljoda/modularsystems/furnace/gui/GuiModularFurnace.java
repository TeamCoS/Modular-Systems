...
public class GuiModularFurnace extends GuiCoreBase<ContainerModularFurnace> {
    ...
    public void addRightTabs(GuiTabCollection tabs) {
        if (core != null) {
            ...
            furnaceInfoSpeed.add(new GuiComponentText(String.format("%.2f", -1 * (100 - ((1600 + core.getValues().getEfficiency()) / 1600) * 100) != 0 ? -1 * (100 - ((1600 + core.getValues().getEfficiency()) / 1600) * 100) : 0.00)  + "%", 15, 58, -1 * (100 - ((1600 + core.getValues().getEfficiency()) / 1600) * 100) > 0 ? 0x5CE62E : -1 * (100 - ((1600 + core.getValues().getEfficiency()) / 1600) * 100) == 0 ? 0x000000 : 0xE62E00));

...
public class VersionManager {
    ...
    public static void init() throws InterruptedException {
        VersionChecker version = new VersionChecker(REMOTE_VERSION_XML_FILE, ConfigRegistry.lastVersion, ConfigRegistry.versionRetry,
                Reference.MOD_ID);
        ...
        if (!ConfigRegistry.lastVersion.equalsIgnoreCase(results.newVersion)) {

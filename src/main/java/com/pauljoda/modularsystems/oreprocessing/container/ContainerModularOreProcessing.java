package com.pauljoda.modularsystems.oreprocessing.container;
...
public class ContainerModularOreProcessing extends Container
{
    ...
    public ContainerModularOreProcessing(InventoryPlayer playerInventory, TileEntitySmelteryCore tileEntity)
    {

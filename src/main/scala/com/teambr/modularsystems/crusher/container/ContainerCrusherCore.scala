...
class ContainerCrusherCore(playerInventory: InventoryPlayer, tile: TileCrusherCore)
    ...
    addSlotToContainer(new SlotFurnaceOutputItemHandler(playerInventory.player, tile, 1, 96, 35))
    addSlotToContainer(new SlotFurnaceOutputItemHandler(playerInventory.player, tile, 2, 126, 35))

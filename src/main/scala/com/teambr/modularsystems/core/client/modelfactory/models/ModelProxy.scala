...
class ModelProxy extends ISmartBlockModel {
    ...
    override def getFaceQuads(facing : EnumFacing) : util.List[_] = {
        ...
        bakedQuads.add(faceBakery.makeBakedQuad(new Vector3f(0.0F, -0.05F, 0.0F), new Vector3f(16.0F, -0.05F, 16.0F), face, hopperTexture, EnumFacing.DOWN, modelRot, null, scale, true))
        bakedQuads.add(faceBakery.makeBakedQuad(new Vector3f(0.0F, 16.05F, 0.0F), new Vector3f(16.0F, 16.05F, 16.0F), face, hopperTexture, EnumFacing.UP, modelRot, null, scale, true))
        bakedQuads.add(faceBakery.makeBakedQuad(new Vector3f(0.0F, 0.0F, -0.05F), new Vector3f(16.0F, 16.0F, -0.05F), face, hopperTexture, EnumFacing.NORTH, modelRot, null, scale, true))
        bakedQuads.add(faceBakery.makeBakedQuad(new Vector3f(0.0F, 0.0F, 16.05F), new Vector3f(16.0F, 16.0F, 16.05F), face, hopperTexture, EnumFacing.SOUTH, modelRot, null, scale, true))
        bakedQuads.add(faceBakery.makeBakedQuad(new Vector3f(16.05F, 0.0F, 0.0F), new Vector3f(16.05F, 16.0F, 16.0F), face, hopperTexture, EnumFacing.EAST, modelRot, null, scale, true))
        bakedQuads.add(faceBakery.makeBakedQuad(new Vector3f(-0.05F, 0.0F, 0.0F), new Vector3f(-0.05F, 16.0F, 16.0F), face, hopperTexture, EnumFacing.WEST, modelRot, null, scale, true))
